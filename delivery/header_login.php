...
<div id="header" class="header">
    ...
    <h2  ><strong class="personal-account-container">
<?php 
          echo ($_POST['login']);
?>
     </strong>
        ...
        <a href="http://magicteam.online/kyrsvoya/index.php"  class="btn btn-reset header-btn"><strong class="personal-account-container">
            Выйти
          </strong>
        </a>
      </div>
